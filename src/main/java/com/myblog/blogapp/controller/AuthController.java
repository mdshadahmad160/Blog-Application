...
public class AuthController {
    @Autowired
    private AuthenticationManager authenticationManager;//it is used to verify the user correct or not
    // Means Verify based on user input type in the form of JSON object
    @Autowired
